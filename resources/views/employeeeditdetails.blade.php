                        ...
                        <div class='row'>
                                ...
                                <div class='col-12' style='padding:15px;'>
                                        <div class='row'>
                                                        ...
                                                        <div class='col-4 form-group'><label class='label mt-1'>Daily Rate</label><input value='{{ old('daily_rate', $empdetails->daily_rate) }}' name='daily_rate' class='content-field form-control form-control-sm' type='number' maxlength="10"></input> @error('daily_rate')<p class='m-0 alert-sm alert-danger shadow-sm'>{{$message}}</p>@enderror </div>   
                                                                                                       
                                        </div>
                                        <div class='row'>
                                                        <div class='col-4 form-group'><label class='label mt-1'>Allowance</label><input value='{{ old('allowance', $empdetails->allowance) }}' name='allowance' class='content-field form-control form-control-sm' type='number' maxlength="10"></input></div>
                                                        <div class='col-4 form-group'><label class='label mt-1'>Service incentive Leave</label><input value='{{ old('leave_bal_SIL', $empdetails->leave_bal_SIL) }}' name='leave_bal_SIL' class='content-field form-control form-control-sm' type='number' maxlength="10"></input></div>
                                                        <div class='col-4 form-group'><label class='label mt-1'>Vacation Leave</label><input value='{{ old('leave_bal_VL', $empdetails->leave_bal_VL) }}' name='leave_bal_VL' class='content-field form-control form-control-sm' type='number' maxlength="10"></input></div>                                                   
                                        </div>
                                        <div class='row'>
